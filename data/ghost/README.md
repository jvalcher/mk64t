...
And we're done. You should now have an updated mpk file in `mpk/`. You can test it out with `run_mpk` (see below) before rebuilding `mk64t` with your new ghost and hopefully submitting a PR!
